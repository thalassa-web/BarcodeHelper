 ...
 * @package ThalassaWeb\BarcodeHelper\code93
 */
class BinEncodeur implements IEncodeur
{
    ...
    {
        $arrData = array_merge(str_split($donnees), str_split($checkDigit));
        return '101011110' . implode('', array_map(function (string $char) {return static::CORRESPONDANCE_BINAIRE[$char];}, $arrData)) . '101011110100000000';
    }
}
